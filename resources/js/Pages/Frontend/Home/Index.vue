...
import Header from "@/Pages/Frontend/Home/Partials/Header.vue"
...
import CallToAction from "@/Pages/Frontend/Home/Partials/CallToAction.vue"
...
<template>
    ...
    <img class="breadcrumb__shape-1" src="/assets/img/breadcrumb/breadcrumb-shape-1.png" alt="shape" />
        ...
        <div class="container tp-container">
            <div class="row gx-3">
                <div class="col-xxl-5 col-xl-5">
                    <div v-if="NEWSLETTER_API" class="subscribe__wrapper p-relative mr-40">
                        <div class="subscribe__inner theme-bg-dark p-relative">
                            <div class="subscribe__shape">
                                <img class="subscribe__shape-1" src="assets/img/cta/cta-shape-1.png" alt="" />
                            </div>
                            ...
                            <div class="app__content d-sm-flex align-items-center">
                                ...
                                <div class="app__info">
                                    ...
                                    <div class="app__download d-sm-flex align-items-center">
                                        <a v-if="home?.action_android_link" :href="home.action_android_link"
                                            target="_blank">
                                            <div class="app__download-item d-flex align-items-center transition-3">
                                                <div class="app__download-icon mr-5">
                                                    <i class="fa-brands" :class="home.action_android_icon_name"></i>
                                                </div>
                                        ...
                                        <a v-if="home?.action_ios_link" :href="home.action_ios_link" target="_blank">
                                            <div class="app__download-item d-flex align-items-center transition-3">
                                                <div class="app__download-icon mr-5">
                                                    <i class="fa-brands" :class="home.action_ios_icon_name"></i>
                                                </div>
                                                <div class="app__download-text">
