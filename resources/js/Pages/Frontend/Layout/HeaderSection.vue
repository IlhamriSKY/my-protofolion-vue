                    ...
                    <div class="row align-items-center">
                        <div class="col-xxl-1 col-xl-1 col-lg-2 col-md-6 col-4">
                            <div class="logo header__logo">
                                <Link href="/">
                                <img class="logo-white" :src="$page.props.primaryData?.logo" alt="logo" />
                                <img class="logo-black" :src="$page.props.primaryData?.logo_dark" alt="logo" />
                                </Link>
                            </div>
                        </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="javascript: void(0);" data-theme="dark"
                                                        class="setColor dark theme__switcher-btn">
                                                        <i class="fa-light fa-moon"></i> {{ trans("Dark") }}
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript: void(0);" data-theme="light"
                                                        class="setColor light theme__switcher-btn">
                                                        <i class="fa-light fa-brightness-low"></i> {{ trans("Light") }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div v-else class="header__wallet ml-30">
                      ...
                      >
                        {{ trans('Login') }}
                                ...
                                <div class="header__bar d-flex align-items-center ml-10 d-xl-none">
                                    <div class="header__notification">
                                        <Link :href="route('user.cart.index')">
                                        <svg id="header-cart-svg" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <button type="button" class="hamurger-btn ml-20" data-bs-toggle="modal"
                    ...
                    <div class="offcanvas__wrapper">
                        <div class="offcanvas__content">
                            ...
                            <div class="offcanvas__search mb-25">
                                <form @submit.prevent="searchPrompt" @keypress.enter="searchPrompt">
                                    <input type="text" v-model="form.s_query" placeholder="What are you searching for?" />
                            ...
                            <div class="offcanvas__contact mt-30 mb-20">
                                ...
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center">
                                        ...
                                        <div class="offcanvas__contact-text">
                                            <a :href="`tel:+${$page.props.primaryData?.contact_phone}`">{{
                                    ...
                                    <li class="d-flex align-items-center">
                                        ...
                                        <div class="offcanvas__contact-text">
                                            <a :href="`mailto:${$page.props.primaryData?.contact_email}`">
                            ...
                            <div class="offcanvas__social">
                                <ul>
                                    <li>
                                        <a target="_blank" v-for="(social, key) in $page.props.primaryData[
                                            'socials'
                                        ]" :href="social" :key="key">
